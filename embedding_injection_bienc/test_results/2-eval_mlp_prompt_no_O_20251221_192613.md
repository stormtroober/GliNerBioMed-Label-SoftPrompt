...
|:-------------|----------:|-------:|---------:|
| **Macro**    | 0.6808 | 0.7266 | **0.6949** |
| **Micro**    | 0.7244 | 0.7634 | **0.7434** |
| Weighted     | 0.7399 | 0.7634 | 0.7466 |

**Token Totali Valutati**: 65,191
...
| **O** (Esclusa dal Macro/Micro) | 0.9566 | 0.9392 | 0.9478 | 48750 | 47865 |
| **TOTAL** | - | - | - | 65191 | 65191 |
...
```
   ...
   micro avg     0.7244    0.7634    0.7434     16441
   macro avg     0.6808    0.7266    0.6949     16441
weighted avg     0.7399    0.7634    0.7466     16441
