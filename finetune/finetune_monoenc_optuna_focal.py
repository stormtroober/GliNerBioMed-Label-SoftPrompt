...
def objective(trial):
    ...
    focal_loss_alpha = trial.suggest_float("focal_loss_alpha", 0.2, 0.9)
    focal_loss_gamma = trial.suggest_float("focal_loss_gamma", 2.0, 5.0)
    ...
    trial_output_dir = f"optuna_models_mono_focal/trial_{trial.number}"
    ...
    try:
        trainer = model.train_model(
            ...
            learning_rate=5e-6,          # Fixed
            lr_scheduler_type="linear",  # Fixed
            weight_decay=0.01,
            others_lr=1e-5,
            ...
            focal_loss_alpha=focal_loss_alpha, # <--- Optimized
...
# Run Optimization
study = optuna.create_study(direction="maximize", study_name="gliner_mono_focal_opt")
...
# Save best params
best_params_path = "best_optuna_params_focal.json"
...
# ==================================================
# Best Trial: 11
# Best Value (Micro F1): 0.6833046471600688
# Best Params: {'focal_loss_alpha': 0.40551794519885276, 'focal_loss_gamma': 2.83001777615741}