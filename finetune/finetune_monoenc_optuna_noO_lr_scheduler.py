...
def objective(trial):
    ...
    trial_output_dir = f"optuna_models_mono/trial_{trial.number}"
...
# Run Optimization
study = optuna.create_study(direction="maximize", study_name="gliner_mono_opt")
...
# Save best params
best_params_path = "best_optuna_params_mono.json"
...
# ==================================================
# Best Trial: 1
# Best Value (Micro F1): 0.7223880597014926
# Best Params: {'learning_rate': 7.746915067305043e-05, 'lr_scheduler_type': 'constant_with_warmup'}
# Best parameters saved to best_optuna_params_mono.json